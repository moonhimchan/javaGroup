...
create table test (
	idx     int not null  auto_increment primary key,  /*고유번호 primary key(기본키)를 설정해야 관계설정을 할수가 있다. 중복을 할수가 없다.*/
...
insert into test values (default,'강소연',19,'여자','제주');  
insert into test values (default,'고릴라',38,'여자','청주');  
