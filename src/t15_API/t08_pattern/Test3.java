...
// 글자수 : {시작글자수,종료글자수}-종료글자수는 생략가능 이메일 주소
public class Test3 {
	public static void main(String[] args) {
		String regEx1="^[a-zA-Z0-9_]+@[a-zA-Z0-9_-]+.[a-z]+$";             //[영문/숫자/밑줄]@[영문/숫자/밑줄/하이푼].[영문(소문자)]
		String regEx2="^[a-zA-Z0-9_]{3,}+@[a-zA-Z0-9_-]+.[a-z]+$";         //(최소3글자)[영문/숫자/밑줄]@[영문/숫자/밑줄/하이푼].[영문(소문자)]
		String regEx3="^[a-zA-Z0-9_]{3,12}+@[a-zA-Z0-9_-]+.[a-z]+$";       //(최소3글자,최대12글자)[영문/숫자/밑줄]@[영문/숫자/밑줄/하이푼].[영문(소문자)]
		String regEx4="^[a-zA-Z0-9_]{3,12}+@[a-zA-Z0-9_-]{1,8}+.[a-z]+$";  //(최소3글자,최대12글자)[영문/숫자/밑줄]@(최소1글자,최대8글자)[영문/숫자/밑줄/하이푼].[영문(소문자)]      
		String regEx5="^\\w{3,}+@[a-zA-Z0-9_-]{1,8}\\.[a-z]{2,4}";         //(최소3글자)(알파벳,숫자만)@(최소1글자,최대8글자)[영문/숫자/밑줄/하이푼].(최소2글자,최대4글자)[영문(소문자)]
		...
		String str09="atom@navernaver.co.kr";
