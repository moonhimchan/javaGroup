...
/*
TreeSet : Set계열, 집합자료구, HashSet의 역활과 같은데, 차이점은 꺼낼때 자료가 자동으로 오름차순 정렬되어 있다.
*/
public class T02_TreeSet {
	public static void main(String[] args) {
		...
		System.out.println("5.higheer() : " + treeSet.higher(11));
		System.out.println("6.higheer() : " + treeSet.higher(10));
